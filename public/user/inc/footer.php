<footer class="bg-dark text-white py-4">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <h5>Contact Us</h5>
                <p>Sayre Highway, San Miguel, Manolo Fortich, Bukidnon</p>
                <p>Email: shaa@thisstore.com</p>
                <p>Phone: +63-905-1234123</p>
            </div>
        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <p>&copy; <?= date('Y') ?> This Store. All rights reserved.</p>
            </div>
            <div class="col-md-6 text-right">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#fff" height="50px" width="50px" version="1.1" id="Capa_1" viewBox="0 0 300.004 300.004" xml:space="preserve">
                <g>
